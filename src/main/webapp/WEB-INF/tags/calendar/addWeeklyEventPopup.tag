...
<div id ="addWeeklyEventPopup" class="eventPopup" title="Add new Event">
	<p class="validateTips">All form fields are required.</p>

	<form id="weeklyEventForm" class="eventForm">
		<fieldset>
			...
			<div class="popupField eventDateField textPopupField">
				...
				<select name="eventFromTime" id="eventFromTime" class="pct40">
					<c:forEach items="${weekCalendar.timeSet}" var="selectedTime">
