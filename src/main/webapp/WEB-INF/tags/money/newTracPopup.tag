...
<div ng-controller="addTracCtrl" class="modal fade" id="newTracPopup" role="dialog" title="Add new monetary transaction" >
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="submit" class="btn btn-primary btn-lg" id="createTracBtn"
					data-dismiss="modal">
					<span class="glyphicon glyphicon-ok"></span> Create a transaction
				</button>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="transactionCreatedPopup" role="dialog">

	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="text-success text-center">
					<span class="glyphicon glyphicon-ok"></span> Transaction Created
				</h4>
			</div>
